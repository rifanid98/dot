...
// DeleteAccount provides a mock function with given fields: ic, id
func (_m *AccountRepository) DeleteAccount(ic *core.InternalContext, id string) *core.CustomError {
	ret := _m.Called(ic, id)
