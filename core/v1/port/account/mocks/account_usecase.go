...
// AccountDelete provides a mock function with given fields: ic, accountId
func (_m *AccountUsecase) AccountDelete(ic *core.InternalContext, accountId string) *core.CustomError {
	ret := _m.Called(ic, accountId)
...
// AccountUpdate provides a mock function with given fields: ic, _a1
func (_m *AccountUsecase) AccountUpdate(ic *core.InternalContext, _a1 *entity.Account) *core.CustomError {
